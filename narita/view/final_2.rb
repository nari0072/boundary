...
class draw_atoms[context,width,height,cx,cy,mv,scale,lines1,lines2,opts={}]
  r = 2
  adjust = scale/1000
  ...
  def xy_atom(context,cx,cy,mv,lines1,lines2,pos_after,adjust,r)
  pos_after.each{|pos|
  ...
  def xz_atom(context,cx,cy,mv,lines1,lines2,pos_after,adjust,r)
  pos_after.each{|pos|
  ...
  def yz_atom(context,cx,cy,mv,lines1,lines2,pos_after,adjust,r)
  pos_after.each{|pos|
