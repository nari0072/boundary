...
各々のグラフは図¥ref{fig:one}のようになり，両者の実験結果における相違点は，以下の通りである．

・Hassonらによるシミュレーション結果では，小傾角粒界エネルギーの0度，及び90度でそれぞれ異なる傾きになった．

・大槻のシミュレーション結果では，0度，及び90度における立ち上がりの傾きが左右対称になった．
