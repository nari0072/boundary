...
\begin{tabular}{cc}
   ...
   (a) & (b)
\end{tabular}
  \caption{(a) Hassonらと(b)大槻が求めたAl(100)対称傾角粒界エネルギーの方位依存性．}
  \label{fig:one}
\end{center}
\end{figure}
...
MVCモデルは，web applicationの開発において取られている手法であり，
...
また，SVGの生成には，
Ruby言語で視覚化を容易に実現できる２次元画像描画ライブラリ"rcairo"を用いる\cite{sudoh}．
